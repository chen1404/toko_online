                                                ...
                                                <form action="{{ route('update', $product->id) }}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" placeholder="Nama Produk" value="{{ $product->nama }}" required />
                                                            @error('nama')
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control @error('harga') is-invalid @enderror" id="harga" name="harga" placeholder="Harga" value="{{ $product->harga }}" required />
                                                            @error('harga')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <option value="{{ $product->kategori }}" selected>{{ ucfirst($product->kategori) }}</option>
