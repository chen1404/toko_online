                                    ...
                                    <a href="" class="nav-link d-inline-block mt-2">
                                        ...
                                        <div id="page-content-wrapper">
                                            <nav class="navbar navbar-expand-lg navbar-light navbar-store fixed-top"
                                                data-aos="fade-down">
                                                <div class="container-fluid">
                                                    <button class="btn btn-secondary d-md-none mr-auto mr2"
                                                        id="menu-toggle">
                                                        &laquo; Menu
                                                    </button>
                                                    <button class="navbar-toggler" type="button" data-toggle="collapse"
                                                    ...
                                                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                                        ...
                                                        <ul class="navbar-nav d-none d-lg-flex ml-auto">
                                                            ...
                                                            <li class="nav-item">
                                                                <a href="" class="nav-link d-inline-block mt-2">
                                                                    >>>>>>> 0c1ffac77483dbd4c9aedf3e73656751ad8a5964
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="file"
                                                                                            ...
                                                                                            accept=".jpg,.jpeg,.png" />
                                                                                        <div
                                                                                            class="row pt-2 d-flex justify-content-start">
                                                                                            <div class="col-5">
                                                                                                <p
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col text-right">
                                                                                <form
                                                                                    action="{{ route('delete', $product->id) }}"
                                                                                    method="post"
